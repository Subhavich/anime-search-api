  ...
  return (
    <>
      <div className="min-h-screen w-full font-mono bg-neutral-950 text-neutral-500">
        <header className=" w-full py-4 text-lg font-extrabold h-36">
          <Navbar />
        </header>
        <Outlet />
      </div>
...
const Navbar = () => {
  return (
    <nav className="max-w-5xl fixed left-[50%] top-8 flex justify-center w-10/12 -translate-x-[50%] items-center gap-6 rounded-lg border-[1px] border-neutral-700 bg-neutral-900 p-4 text-sm text-neutral-500">
      <p>Anime Browser</p>
