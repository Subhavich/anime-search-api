...
const Navbar = () => {
  return (
    <nav className=" fixed left-[50%] top-8 flex justify-center w-10/12 -translate-x-[50%] items-center gap-6 rounded-lg border-[1px] border-neutral-700 bg-neutral-900 p-4 text-sm text-neutral-500">
      <p>Anime Browser</p>
